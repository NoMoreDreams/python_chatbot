    ...
    if request.method == 'POST':
        ...
        bot = ChatBot('Test', logic_adapters=[
            ...
            },
            {
                ...
                'default_response': "I am sorry, I didn't catched what you meant, but I am constantly learning. Could "
                                    "you please repeat your question in other words? "
        ...
        # 29.04.2020: uncommented, since I only want to train once, due to performance;
        # but you must uncomment this if you run it the first time
